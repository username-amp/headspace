            ...
            <SettingsLayout>
                <div className="space-y-8">
                    ...
                    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-500 via-yellow-500 to-amber-600 p-8 text-white shadow-xl">
                        <div className="relative z-10">
                            <div className="mb-4 inline-flex rounded-full bg-white/20 px-4 py-2 backdrop-blur-sm">
                                <Palette className="mr-2 h-5 w-5 text-amber-200" />
                    ...
                    <div className="grid gap-4 sm:grid-cols-3">
                        <Card className="group hover:ring-offset-background cursor-pointer overflow-hidden transition-all hover:scale-[1.02] hover:ring-2 hover:ring-amber-500/30 hover:ring-offset-2">
                            <CardContent className="p-6">
                                <div className="flex items-center gap-4">
                                    <div className="rounded-xl bg-gradient-to-br from-amber-500 to-yellow-600 p-2.5 text-white">
                        ...
                        <Card className="group hover:ring-offset-background cursor-pointer overflow-hidden transition-all hover:scale-[1.02] hover:ring-2 hover:ring-amber-500/30 hover:ring-offset-2">
                            <CardContent className="p-6">
                                <div className="flex items-center gap-4">
                                    <div className="rounded-xl bg-gradient-to-br from-amber-600 to-yellow-700 p-2.5 text-white">
                        ...
                        <Card className="group hover:ring-offset-background cursor-pointer overflow-hidden transition-all hover:scale-[1.02] hover:ring-2 hover:ring-amber-500/30 hover:ring-offset-2">
                            <CardContent className="p-6">
                                <div className="flex items-center gap-4">
                                    <div className="rounded-xl bg-gradient-to-br from-yellow-500 to-amber-600 p-2.5 text-white">
