...
function MeditationCard({ item }: { item: MeditationItem }) {
    return (
        <Link href={route('meditate.details', item.id)} className="block">
            <Card className="group relative overflow-hidden rounded-2xl bg-black/5 backdrop-blur-sm transition-transform hover:scale-[1.02]">
                <div className="aspect-video w-full overflow-hidden">
                    {item.image_url ? (
                        ...
                        <div className="flex h-full items-center justify-center bg-gradient-to-br from-indigo-500/20 to-purple-600/20">
                            <Flower2 className="h-12 w-12 text-indigo-500" />
                        </div>
                    )}
                </div>
                        ...
                        <section key={section.title} className="relative">
                            <div className="mb-6 flex items-center gap-3">
                                <div className="rounded-full bg-indigo-500/20 p-2">
                                    <Flower2 className="h-6 w-6 text-indigo-500" />
                                </div>
                                <div>
